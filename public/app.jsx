...
function BrandMachina() {
  ...
  const sendToClaude = useCallback(async (userMessage, newHistory, isDescDone) => {
    ...
    if (!result) {
      setChatMsgs(prev => [...prev, { from: "ai", content: 'API call failed — open browser console (F12) for details. Check that your ANTHROPIC_API_KEY is set in Vercel environment variables.' }]);
      return;
    }
